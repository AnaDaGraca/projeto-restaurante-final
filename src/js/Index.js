...
botoes.forEach((botao, indice) => {
    botao.addEventListener("click", () => {
        ...
        pratos[indice].classList.add("selecionado");
    });
});

function desselecionarpratos() {
    const pratosSelecionado = document.querySelector(".pratos.selecionado");
    pratosSelecionado.classList.remove("selecionado");
}
